...
try:
    ...
    from src.database.models import DailyRoutine, SeniorProfile, RoutineStatusEnum
    from src.database.schemas import GenerateRequest, DailyRoutineResponse
    from src.api.config import settings
except ImportError:
    try:
        from ..database.database import get_db
        from ..database.models import DailyRoutine, SeniorProfile, RoutineStatusEnum
        from ..database.schemas import GenerateRequest, DailyRoutineResponse
